...
INSERT OR IGNORE INTO mcc_codes (code, description, category) VALUES
  ...
  -- Codes that turn up on a Singapore statement often enough to be worth
  -- naming. Descriptions follow ISO 18245; the category column is this app's
  -- own mapping onto earn_rules, not part of the standard.
  ('5811','Caterers','dining'),
  ('5451','Dairy product stores','groceries'),
  ...
  ('5211','Building materials and lumber','shopping'),
  ('5231','Glass, paint and wallpaper','shopping'),
  ('5251','Hardware stores','shopping'),
  ('5261','Nurseries, lawn and garden','shopping'),
  ('5641','Children''s and infants'' wear','shopping'),
  ('5621','Women''s ready-to-wear','shopping'),
  ('5611','Men''s and boys'' clothing','shopping'),
  ('5631','Women''s accessory and speciality','shopping'),
  ('5681','Furriers and fur shops','shopping'),
  ('5697','Tailors and alterations','shopping'),
  ('5698','Wig and toupee stores','shopping'),
  ('5699','Miscellaneous apparel and accessories','shopping'),
  ('5734','Computer software stores','shopping'),
  ('5735','Record and music stores','shopping'),
  ('5733','Music stores, instruments','shopping'),
  ('5943','Stationery and office supplies','shopping'),
  ('5941','Sporting goods stores','shopping'),
  ('5946','Camera and photographic supply','shopping'),
  ('5947','Gift, card, novelty and souvenir','shopping'),
  ('5948','Luggage and leather goods','shopping'),
  ('5949','Sewing, needlework and fabric','shopping'),
  ('5950','Glassware and crystal stores','shopping'),
  ('5970','Artist supply and craft shops','shopping'),
  ('5992','Florists','shopping'),
  ('5993','Cigar stores and stands','shopping'),
  ('5994','News dealers and newsstands','shopping'),
  ('5995','Pet shops and pet supplies','shopping'),
  ('7230','Beauty and barber shops','health'),
  ('7298','Health and beauty spas','health'),
  ('7297','Massage parlours','health'),
  ('7299','Miscellaneous personal services','health'),
  ('7210','Laundry and dry cleaning','health'),
  ('7216','Dry cleaners','health'),
  ('8043','Opticians and eyeglasses','health'),
  ('8041','Chiropractors','health'),
  ('8042','Optometrists and ophthalmologists','health'),
  ('8049','Podiatrists and chiropodists','health'),
  ('8071','Medical and dental laboratories','health'),
  ('5122','Drugs and pharmaceuticals, wholesale','health'),
  ('4112','Passenger railways','transport'),
  ('4789','Transportation services, other','transport'),
  ('7534','Tyre retreading and repair','transport'),
  ('7538','Automotive service shops','transport'),
  ('7531','Automotive body repair','transport'),
  ('5533','Automotive parts and accessories','transport'),
  ('5532','Automotive tyre stores','transport'),
  ('5511','Car and truck dealers, sales and service','transport'),
  ('5571','Motorcycle dealers','transport'),
  ('7542','Car washes','transport'),
  ('4582','Airports and terminals','travel'),
  ('4457','Boat rentals and leasing','travel'),
  ('7012','Timeshares','travel'),
  ('7033','Campgrounds and trailer parks','travel'),
  ('4215','Courier services','shopping'),
  ('4812','Telecommunication equipment and phone sales','utilities'),
  ('4813','Key-entry telecom merchant','utilities'),
  ('4816','Computer network and information services','utilities'),
  ('4821','Telegraph services','utilities'),
  ('7372','Computer programming and software','utilities'),
  ('7399','Business services, other','utilities'),
  ('5817','Digital goods, applications','online'),
  ('5818','Digital goods, large merchant','online'),
  ('5815','Digital goods, media and books','online'),
  ('5816','Digital goods, games','online'),
  ('7311','Advertising services','utilities'),
  ('7392','Management and consulting services','utilities'),
  ('7393','Detective and security services','utilities'),
  ('7911','Dance halls and schools','entertainment'),
  ('7929','Bands, orchestras and entertainers','entertainment'),
  ('7932','Billiard and pool establishments','entertainment'),
  ('7933','Bowling alleys','entertainment'),
  ('7941','Sports clubs and promoters','entertainment'),
  ...
  ('7999','Recreation services, other','entertainment'),
  ('8351','Child care services','education'),
  ('8241','Correspondence schools','education'),
  ('8244','Business and secretarial schools','education'),
  ('8249','Trade and vocational schools','education'),
  ('8111','Legal services and attorneys','government'),
  ('8641','Civic, social and fraternal associations','charity'),
  ('8651','Political organisations','charity'),
  ('8661','Religious organisations','charity'),
  ('8675','Automobile associations','charity'),
  ('8699','Membership organisations, other','charity'),
  ('6010','Financial institutions, manual cash disbursements','financial'),
  ('6011','Financial institutions, automated cash (ATM)','financial'),
  ('6211','Securities, brokers and dealers','financial'),
  ...
  ('6540','Stored value card and wallet top-up','financial'),
  ...
  ('9402','Postal services, government','government'),
  ('9405','Government purchases, intra-government','government'),
  ('9700','Automated referral service','government'),
  ('9950','Intra-company purchases','government'),
  ('1711','Heating, plumbing and air conditioning','home'),
  ('1731','Electrical contractors','home'),
  ('1740','Masonry and tile work','home'),
  ('1750','Carpentry contractors','home'),
  ('1761','Roofing and sheet metal','home'),
  ('1771','Concrete work contractors','home'),
  ('1799','Special trade contractors','home'),
  ('7622','Electronics repair','home'),
  ('7623','Air conditioning and refrigeration repair','home'),
  ('7629','Appliance repair','home'),
  ('7641','Furniture reupholstery and repair','home'),
  ('7692','Welding services','home'),
  ('7699','Repair services, other','home'),
  ('7261','Funeral services and crematoria','other'),
  ('7273','Dating services','other'),
  ('7276','Tax preparation services','other'),
  ('7277','Counselling services','other'),
  ('7278','Buying and shopping clubs','other'),
  ('7296','Clothing rental','other'),
  ('7321','Consumer credit reporting','financial'),
  ('7338','Quick copy and blueprinting','other'),
  ('7339','Stenographic and secretarial support','other'),
  ('7342','Disinfecting and pest control','home'),
  ('7349','Cleaning and maintenance services','home'),
  ('7361','Employment agencies','other'),
  ('7375','Information retrieval services','utilities'),
  ('7379','Computer maintenance and repair','utilities'),
  ('7394','Equipment rental and leasing','other'),
  ('7395','Photofinishing laboratories','other'),
  ('7801','Government licensed online casinos','financial'),
  ('7802','Government licensed horse and dog racing','financial'),
  ('9754','Gambling, horse and dog racing','financial'),
  ('5271','Mobile home dealers','shopping'),
  ('5551','Boat dealers','shopping'),
  ('5561','Recreational and utility trailers','shopping'),
  ('5592','Motor home dealers','shopping'),
  ('5598','Snowmobile dealers','shopping'),
  ('5599','Automotive dealers, other','shopping'),
  ('5935','Wrecking and salvage yards','other'),
  ('5937','Antique reproductions','shopping'),
  ('5940','Bicycle shops','shopping'),
  ('5932','Antique shops','shopping'),
  ('5933','Pawn shops','other'),
  ('5931','Second hand and used merchandise','shopping'),
  ('4225','Public warehousing and storage','other'),
  ('4214','Motor freight carriers and trucking','other'),
  ('4468','Marinas and marine supplies','travel'),
  ('3000','Airline, individual carrier','travel'),
  ('3500','Lodging, individual hotel chain','travel'),
  ('3351','Car rental, individual agency','travel');
